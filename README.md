...
_Add screenshots here to showcase the results and the process._

![Payment Schedule Screenshot](path/to/your/screenshot1.png)
![Processed Data Screenshot](path/to/your/screenshot2.png)
